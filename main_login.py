...
from utils.id_utils import get_id_info, sava_id_info, verify_password # 账号信息工具函数
...
# from Major_Window import Main_window
from main_first import Main_window
# 界面登录
class win_Login(QMainWindow):
    ...
    def onSignIn(self):
        ...
        if username not in USER_PWD.keys():
            ...
            # 若登陆成功，则跳转主界面
            if verify_password(password, USER_PWD[username]):
